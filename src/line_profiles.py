...
def p_cygni_line_corr_rel_1d(wl_target, vmax, vphot, tau, lam0_AA, t0, use_nlte=True):
    ...
    f_normed = calc_rel_line_profile_with_ltt(nu_arr, lam0_AA, vmax_cgs, vphot_cgs, tau, t0, c_cgs, n_p=60,
                                              use_nlte=use_nlte)
...
def get_combined_pcygni_profile(wav, vmax, vphot, tau_sr, tau_he, t0, use_nlte, use_he,
                                combine_optical_depths_beer_lambert):
